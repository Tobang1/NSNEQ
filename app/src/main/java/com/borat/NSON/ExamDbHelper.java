...
// Biology Questions
        ...
        addQuestion(q70);
        Question q71 = new Question("If the normal atm pressure in a laboratory supports a column of mecury 0.76m high and the relative density of mecury is 13.8, then the height of water column which amt pressure will support in the same laboratory at the same time is", "A: 0m ", "B: 10m ", "C: 13m ", "D: 18m ",4, Category.PHYSICS );
        addQuestion(q71);
